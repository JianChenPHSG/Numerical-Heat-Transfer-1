...
C----------------------------------------------------------------------
      ENTRY OUTPUT
        ...
        IF(MOD(ITER,20).EQ.0) THEN
          WRITE(8,403) ITER,U(22,10),V(22,10),T(22,10),SMAX
          WRITE(*,403) ITER,U(22,10),V(22,10),T(22,10),SMAX
        END IF

  400   FORMAT(13X,'ITER',12X,'U(62,10)',12X,'V(62,10)',12X,
     &                       'T(62,10)',12X,'SMAX')
...
C----------------------------------------------------------------------
	FUNCTION PROP(T,TABLE) 
	  DIMENSION TABLE(120)
	  IF(ABS(T)<300.) T=300.
	  IF(ABS(T)>24100..OR.(ISNAN(T))) T=24000.
